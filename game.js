for (var i=0; i<9; i++) {
	...
	function checkwinner(){
		...
		if (allblock[6].innerHTML=='X' && allblock[4].innerHTML=='X' && allblock[2].innerHTML=='X') alert('X WINS!');
		//
		...
		if (allblock[6].innerHTML=='O' && allblock[4].innerHTML=='O' && allblock[2].innerHTML=='O') alert('O WINS!');
	}
}